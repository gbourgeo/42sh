...
static t_higharea *internal_ft_highlight_merge(t_higharea *harea);
static t_higharea *internal_ft_highlight_new_area(t_higharea *htexts, size_t pos);
static t_higharea *internal_ft_highlight_sort_by_position(t_higharea *harea);
static t_higharea *internal_ft_highlight_remove_area(t_cmd      *command,
                                                     t_higharea *harea);
...
t_higharea *ft_command_highlight_get_area(t_higharea *htexts, size_t pos)
{
    ...
    if (first != NULL)
    {
        ...
        while (htexts != NULL)
        {
            if (pos < htexts->tail)
            {
                ...
                return (internal_ft_highlight_new_area(htexts, pos));
            }
            if (pos <= htexts->head)
            {
                return (htexts);
    ...
    /* Création d'une nouvelle zone */
    return (internal_ft_highlight_new_area(first, pos));
}
...
void ft_command_highlight_move_areas(t_cmd *command, e_highop operation, size_t value)
{
    ...
    int         hmode = _test_bit(command->option, COMMAND_HIGHLIGHT_MODE);
        ...
        {                                           /* **************************************************** */
            ...
            {                                       /*                                                      */
                ...
                {                                   /*                                                      */
                    ...
                    {                               /* Hareas:   | - |       | - - - - - - - | *   | - - |  */
                        harea = internal_ft_highlight_remove_area(command, harea);
                                                    /* Result:   | - |       *                     | - - |  */
            ...
            {                                       /*                                                      */
                ...
                {                                   /*                                                      */
                    ...
                    {                               /* Highlight Mode : OFF                                 */
                        if (hmode == 0)             /* Hareas:   | - |       * - - - - - - - |   | - - |    */
                        {                           /* Result:   | - |       *                   | - - |    */
                            harea = internal_ft_highlight_remove_area(command, harea); /* on supprime la zone et */
...
t_higharea *ft_command_highlight_sort_area(t_higharea *harea)
{
    ...
    harea = internal_ft_highlight_sort_by_position(harea);
    /* Merge des zones qui se chevauchent */
    harea = internal_ft_highlight_merge(harea);
    return (harea);
}
